...
<script type="text/javascript" src="resources/script/Cscript.js?ver=28"></script>
<script type="text/javascript" src="//dapi.kakao.com/v2/maps/sdk.js?appkey=3402980874dd067df556619596251323"></script>

<link rel="stylesheet" href="resources/css/Cstyle.css?ver=139" />
...
<div class="" id="map-modal-bg" onclick="closeMap()">
    ...
    <input type="hidden" id="user_longitude" value="" name="user_longitude">
      ...
      <nav id="bodyclass3" class="navbar bg-dark">
         <div id="bodyclass4" class="container">
            <div>
               <h1 class="title">호텔</h1>
               <div class="dropdown">
                  <button type="button" id="dist_text" value="${dist }" class="dropbtn2">서울 > 강남/역삼/삼성/신사/청담</button>
                  ...
                  <div class="dropdown-content">
                     <div class="tab">
                        ...
                        <button class="tablinks"
                           onmouseover="openCity(event, 'gangwon')">강원</button>
                        <button class="tablinks"
                           onmouseover="openCity(event, 'gyeonggi')">경기</button>
                        <button class="tablinks"
                           onmouseover="openCity(event, 'incheon')">인천</button>
                        <button class="tablinks"
                     ...
                     <div id="seoul" class="tabcontent">
                        <a href="hotel?dist=1">강남/역삼/삼성/신사/청담</a> <a href="hotel?dist=2">서초/교대</a> <a href="hotel?dist=3">잠실/송파/왕십리/강동</a> 
                        <a href="hotel?dist=4">을지로/시청/명동</a> <a href="hotel?dist=5">종로/인사동/동대문/강북</a> <a
                           href="hotel?dist=6">서울역/이태원/용산</a> <a href="hotel?dist=7">마포/홍대/신촌/서대문</a> <a
                           href="hotel?dist=8">영등포/여의도/김포공항</a> <a href="hotel?dist=9">구로/금천/관악/동작</a>
                     </div>

                     <div id="busan" class="tabcontent">
                        <a href="hotel?dist=10">해운대(센텀,송정)</a> <a href="hotel?dist=11">광안리/기장</a> <a href="hotel?dist=12">부산역/남포/자갈치/영도</a>
                        <a href="hotel?dist=13">서면/동래/연제/남구</a> <a href="hotel?dist=14">김해공항/기타 (그외 지역)</a>
                     </div>

                     <div id="jeju" class="tabcontent">
                        <a href="hotel?dist=15">제주공항/애월/함덕</a> <a href="hotel?dist=16">서귀포시/중문/표선/성산</a>
                     </div>
                     ...
                     <div id="gyeonggi" class="tabcontent">
                        ...
                        <a href="#">고양/의정부/파주/김포</a> <a href="#">시흥/군포/광명</a> <a
                           href="#">남양주시/구리/하남</a> <a href="#">가평/양평</a>
                     </div>
    ...
    class="datepicker-here"/>
                  ...
                  <div class="sel_checkbox2">
                     ...
                     <div class="sub_col">
                        <p>
                           <input id="${fivestar}" name="grade" value="fivestar" type="checkbox" />5성급
                        </p>
                        <p>
                           <input id="${fspecial}" name="grade" value="fspecial" type="checkbox" />특1급
                        </p>
                        <p>
                           <input id="${special}" name="grade" value="special" type="checkbox" />특급
                        </p>
                     </div>
                     <p class="form_title">
                     ...
                     <div class="bed">
                        <div class="singleroom" onclick="singleroom()">
                           <input value="SINGLEROOM" name="bedtype" type="checkbox" id="box1"> <img id="img1"
                              src="resources/img/single-black.png" alt="" >
                           <p id="text1">싱글</p>
                        </div>
                        <div class="doubleroom" onclick="doubleroom()">
                           <input value="DOUBLEROOM" name="bedtype" type="checkbox" id="box2"> <img id="img2"
                              src="resources/img/double-black.png" alt="">
                           <p id="text2">더블</p>
                        </div>
                        <div class="twinroom" onclick="twinroom()">
                           <input value="TWINROOM" name="bedtype" type="checkbox" id="box3"> <img id="img3"
                              src="resources/img/twin-black.png" alt="">
                           <p id="text3">트윈</p>
                        </div>
                        <div class="ondolroom" onclick="ondolroom()">
                           <input value="ONDOLROOM" name="bedtype" type="checkbox" id="box4"> <img id="img4"
       ...
       <script>
                         ...
                         //윈도우창 모바일창 날짜입력값 유지
                           ...
                           if(document.getElementById('dist_text').value==2){document.getElementById('dist_text').innerHTML = "서울 > 서초/교대";}
                           if(document.getElementById('dist_text').value==3){document.getElementById('dist_text').innerHTML = "서울 > 잠실/송파/왕십리/강동";}
                           if(document.getElementById('dist_text').value==4){document.getElementById('dist_text').innerHTML = "서울 > 을지로/시청/명동";}
                           if(document.getElementById('dist_text').value==5){document.getElementById('dist_text').innerHTML = "서울 > 종로/인사동/동대문/강북";}
                           if(document.getElementById('dist_text').value==6){document.getElementById('dist_text').innerHTML = "서울 > 서울역/이태원/용산";}
                           if(document.getElementById('dist_text').value==7){document.getElementById('dist_text').innerHTML = "서울 > 마포/홍대/신촌/서대문";}
                           if(document.getElementById('dist_text').value==8){document.getElementById('dist_text').innerHTML = "서울 > 영등포/여의도/김포공항";}
                           if(document.getElementById('dist_text').value==9){document.getElementById('dist_text').innerHTML = "서울 > 구로/금천/관악/동작";}
                           if(document.getElementById('dist_text').value==10){document.getElementById('dist_text').innerHTML = "부산 > 해운대(센텀,송정)";}
                           if(document.getElementById('dist_text').value==11){document.getElementById('dist_text').innerHTML = "부산 > 광안리/기장";}
                           if(document.getElementById('dist_text').value==12){document.getElementById('dist_text').innerHTML = "부산 > 부산역/남포/자갈치/영도";}
                           if(document.getElementById('dist_text').value==13){document.getElementById('dist_text').innerHTML = "부산 > 서면/동래/연제/남구";}
                           if(document.getElementById('dist_text').value==14){document.getElementById('dist_text').innerHTML = "부산 > 김해공항/기타 (그외 지역)";}
                           if(document.getElementById('dist_text').value==15){document.getElementById('dist_text').innerHTML = "제주 > 제주공항/애월/함덕";}
                           if(document.getElementById('dist_text').value==16){document.getElementById('dist_text').innerHTML = "제주 > 귀포시/중문/표선/성산";}

...
public class AccommodationDto {
	...
	private int acc_srprice;
	private int acc_drprice;
	private int acc_twprice;
	private int acc_onprice;
	private int acc_latitude;
	private int acc_longitude;
	...
	public String getAcc_rating() {
		return acc_rating;
	}
	public void setAcc_rating(String acc_rating) {
	...
	public int getAcc_srprice() {
		return acc_srprice;
	}
	public void setAcc_srprice(int acc_srprice) {
		this.acc_srprice = acc_srprice;
	}
	...
	public int getAcc_latitude() {
		return acc_latitude;
	}
	public void setAcc_latitude(int acc_latitude) {
		this.acc_latitude = acc_latitude;
	}
	public int getAcc_longitude() {
		return acc_longitude;
	}
	public void setAcc_longitude(int acc_longitude) {
